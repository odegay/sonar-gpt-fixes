...
In the updated code, the previously empty `stop()` method was left not implemented and instead throws an UnsupportedOperationException, as suggested by SonarQube.